            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0" style="padding: 5px !important;">
                ...
                <div style="text-align: center; margin-top: 1.4rem;">
                  <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 150px; height: 52px; padding-top: 14px; margin: 5px !important;" href="{{route('user.edit.email')}}">Change Email</a>
                  <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 150px; height: 52px; padding-top: 14px; margin: 5px !important;" href="{{route('user.edit.password')}}">Change Password</a>
                  <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 150px; height: 52px; margin: 5px !important;" href="{{route('user.edit.picture')}}">Change Profile Picture</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="tab-content">
                  ...
                  <div id="facebook" class="tab-pane active">
                    ...
                    <div style="text-align: center;">
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/user-profile/connect-with-facebook" onclick="event.preventDefault(); document.getElementById('facebook-connect').submit();">
                      ...
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/user-profile/remove-from-facebook" onclick="event.preventDefault(); document.getElementById('facebook-remove').submit();">
                  ...
                  <div id="github" class="tab-pane">
                    ...
                    <div style="text-align: center;">
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/user-profile/connect-with-github" onclick="event.preventDefault(); document.getElementById('github-connect').submit();">
                        Connect with GitHub
                      ...
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/user-profile/remove-from-github" onclick="event.preventDefault(); document.getElementById('github-remove').submit();">
                        Remove from GitHub
                  ...
                  <div id="google" class="tab-pane">
                    ...
                    <div style="text-align: center;">
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/user-profile/connect-with-google" onclick="event.preventDefault(); document.getElementById('google-connect').submit();">
                        Connect with Google
                      ...
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/user-profile/remove-from-google" onclick="event.preventDefault(); document.getElementById('google-remove').submit();">
                        Remove from Google
