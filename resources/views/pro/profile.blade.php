                  ...
                  <div class="nav-wrapper position-relative end-0">
                    <div style="display: flex; justify-content: center; align-items: center;">
                      <div class="social_tabs">
                        <a id="facebook_tab" href="/pro-profile/show-facebook-tab" class="social_tabs_links" style="background-color: #ffffff; box-shadow: 0 1px 5px 1px #ddd;" onclick="switchFacebookTab(event)">
                          <i class="fa fa-facebook-f"></i>
                        </a>
                      </div>
                      <div class="social_tabs">
                        <a id="github_tab" href="/pro-profile/show-github-tab" class="social_tabs_links" style="background-color: #F8F9FA; box-shadow: none" onclick="switchGithubTab(event)">
                          <i class="fa fa-github"></i>
                        </a>
                      </div>
                      <div class="social_tabs">
                        <a id="google_tab" href="/pro-profile/show-google-tab" class="social_tabs_links" style="background-color: #F8F9FA; box-shadow: none;" onclick="switchGoogleTab(event)">
                          <i class="fa fa-google"></i>
                        </a>
                      </div>
                    </div>
                    @php
                      $type_profile = 'pro-profile';
                    @endphp
