                ...
                <div class="tab-content">
                  ...
                  <div id="facebook" class="tab-pane active">
                    ...
                    <div style="text-align: center;">
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/pro-profile/connect-with-facebook" onclick="event.preventDefault(); document.getElementById('facebook-connect').submit();">
                      ...
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/pro-profile/remove-from-facebook" onclick="event.preventDefault(); document.getElementById('facebook-remove').submit();">
                  ...
                  <div id="github" class="tab-pane">
                    ...
                    <div style="text-align: center;">
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/pro-profile/connect-with-github" onclick="event.preventDefault(); document.getElementById('github-connect').submit();">
                        Connect with GitHub
                      ...
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/pro-profile/remove-from-github" onclick="event.preventDefault(); document.getElementById('github-remove').submit();">
                        Remove from GitHub
                  ...
                  <div id="google" class="tab-pane">
                    ...
                    <div style="text-align: center;">
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/pro-profile/connect-with-google" onclick="event.preventDefault(); document.getElementById('google-connect').submit();">
                        Connect with Google
                      ...
                      <a class="btn btn-outline-primary btn-sm mb-0 me-3" style="width: 200px; height: 52px; padding-top: 14px; margin: 5px !important;" href="/pro-profile/remove-from-google" onclick="event.preventDefault(); document.getElementById('google-remove').submit();">
                        Remove from Google
