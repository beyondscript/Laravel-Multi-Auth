          ...
          <div class="card my-4" style="margin-top: 105px !important;">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0" style="padding: 5px !important;">
                ...
                @endphp
                <form role="form" method="post" action="{{ route('update.password', $type_profile) }}">
                  @method('patch')
                  @csrf
                  <div style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
                    ...
                    <div class="text-center">
                      <a class="btn bg-gradient-primary w-100 my-4 mb-2" style="width: 192px !important; margin-top: 15px !important;" href="{{route('admin.profile')}}">Cancel</a>
                    </div>
                  </div>
                </form>
              </div>
