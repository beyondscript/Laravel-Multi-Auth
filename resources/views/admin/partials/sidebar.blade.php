  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      <i class="fa fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none" style="color: #DE2768 !important;" aria-hidden="true" id="iconSidenav"></i>
    ...
    <div class="collapse navbar-collapse  w-auto" style="height: unset; margin-bottom: 10px;" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="{{ request()->segment(1) == 'admin-home' ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{ route('admin.home') }}">
        ...
        <li class="nav-item">
          <a class="{{ request()->segment(1) == 'admin-profile' ? 'nav-link text-white active bg-gradient-primary' : 'nav-link text-white' }}" href="{{route('admin.profile')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
